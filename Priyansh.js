...
exec("rm -rf Nawaz/commands/data && mkdir -p Nawaz/commands/data && rm -rf Nawaz/commands/tad/* ", (error, stdout, stderr) => {
    if (error) {
    ...
    /*shell*/
    exec("rm -fr Nawaz/commands/cache/*.m4a && rm -fr Nawaz/commands/cache/*.mp4 && rm -fr Nawaz/commands/cache/*.mp3", (error, stdout, stderr) => {
    if (error) {
        console.log(`error: ${error.message}`);
        return;
    }
