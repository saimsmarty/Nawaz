module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "CataliCS",
  description: "Get your current rank on the bot system with a frame according to your level, remake rank_card from canvacord",
...
module.exports.onLoad = async function () {
  ...
  const path = resolve(__dirname, "cache", "customrank");
    ...
    if (!existsSync(resolve(__dirname, 'cache', 'regular-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/priyanshu192/Rankcard/main/Fonts/regular-font.ttf", resolve(__dirname, 'cache', 'regular-font.ttf'));
  if (!existsSync(resolve(__dirname, 'cache', 'bold-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/priyanshu192/Rankcard/main/Fonts/bold-font.ttf", resolve(__dirname, 'cache', 'bold-font.ttf'));
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard.png'))) await downloadFile("https://raw.githubusercontent.com/priyanshu192/Rankcard/main/Png/rankcard.png", resolve(__dirname, 'cache', 'rankcard.png'));
}
...
module.exports.run = async ({ event, api, args, Currencies, Users }) => {
  ...
  if (args.length == 0) {
    ...
    if (rank == 0) return api.sendMessage("You are not currently in the database so you cannot see your ranking, please try again in 5 seconds.", event.threadID, event.messageID);
