...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. Ye sab ke alawa kuch bolna nhi ata Kya tumko Chalo Assalamu Alaikum BoLO", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "inbox") || (event.body.toLowerCase() == "ib")) {
   ...
   if ((event.body.toLowerCase() == "bot owner") || (event.body.toLowerCase() == "admin")) {
     return api.sendMessage("★𝗢𝘄𝗻𝗲𝗿 + 𝗠𝗮𝗱𝗲 𝗕𝘆★\n\n                                                           ✦Ŋʌ͜͡ẅʌʑ Ahɱʌ͜͡ɗ✦\n                          \n\n☞★★᭄𝗖𝗿𝗲𝗱𝗶𝘁'𝘀 :  ✦𒁍⃝𓆩̬𝐍ɑ͜͡𝘄ɑ͜͡𝐳𓆪᭄🩷🪽✦`🥀🦋 🖤", threadID);
   };
if ((event.body.toLowerCase() == "sim") || (event.body.toLowerCase() == "simi")) {
     return api.sendMessage("Sim Sim Na KRr IjjaT Sy MeRa Prefix LaGa 0or Bt kRr ITna Free Nhi Rheta Me 😎🤞", threadID);
   };
...
if ((event.body.toLowerCase() == "😀") || (event.body.toLowerCase() == "😀😀")) {
   ...
   if ((event.body.toLowerCase() == "@everyone") || (event.body.toLowerCase() == "Koi Hai kiya")) {
     return api.sendMessage("Main Hu na jaani ❤️", threadID);
   };

   if ((event.body.toLowerCase() == "Nawaz") || (event.body.toLowerCase() == "nawaz") || (event.body.toLowerCase() == "KIDR HO Nawaz") || (event.body.toLowerCase() == "Boss")) {
     return api.sendMessage( "Busy Honge Work Me😑Main t0 Hoon yar 😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner") || (event.body.toLowerCase() == "create you")) {
   ...
   if ((event.body.toLowerCase() == "Bot tumhe kisne banaya hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Nawaz Ahmad ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Raha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "Bot admin") || (event.body.toLowerCase() == "Bot ka admin kon hai")) {
     return api.sendMessage("He is Nawaz. He Gives his name Mr Nawaz everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "malik se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
     return api.sendMessage("sorry Nawaz boss maaf kr do ab nhi kruga 🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chumma de") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️sab dekh rahe hai janu khopche me chalo na 🙈", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "nawaz kon hai") || (event.body.toLowerCase() =="butterfly kon hai")) {
     return api.sendMessage("️Nawaz mere boss hai Me ek bot hu mujhe Nawaz boss ne BNAYA hai 😍😍💞", threadID);
   };
